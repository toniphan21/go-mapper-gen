...
test-features: build-go-mapper-gen
	./bin/go-mapper-gen test features/*.md testdata/*.md converters/grpc/features/*.md converters/pgtype/features/*.md

generate-examples: build-go-mapper-gen
	rm -rf ./examples
	./bin/go-mapper-gen test features/*.md testdata/*.md converters/grpc/features/*.md converters/pgtype/features/*.md -e -s
