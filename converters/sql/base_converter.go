...
func (b *baseConverter[T, V]) sqlTypeToTarget(ctx gen.ConverterContext, target, source gen.Symbol, opts gen.ConverterOption) jen.Code {
	/** generated code:
...
func (b *baseConverter[T, V]) sqlTypeToTargetToOther(ctx gen.ConverterContext, target, source gen.Symbol, oc gen.Converter, opts gen.ConverterOption) jen.Code {
	/** generated code:
	var v0 [[Target]]
	if {source}.[[ValidPropertyName]] {
...
func (b *baseConverter[T, V]) targetToSQLType(ctx gen.ConverterContext, target, source gen.Symbol, opts gen.ConverterOption) jen.Code {
	/** generated code:
	if {source} != nil {
...
func (b *baseConverter[T, V]) otherToTargetToSQLType(ctx gen.ConverterContext, target, source gen.Symbol, oc gen.Converter, opts gen.ConverterOption) jen.Code {
	/** generated code:
	var v0 [[Target]]
