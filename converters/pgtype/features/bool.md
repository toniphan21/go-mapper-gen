...
### Bool for nullable boolean

when you have a nullable `boolean` column in your database, `sqlc` will
generate type `pgtype.Bool`, the golang equivalent type is `*bool`.
...
[//]: # (EmitCode:examples/sqlc/pgtype/01-bool)
