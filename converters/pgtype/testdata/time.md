...
when you have a `time` column in your database, `sqlc` will
generate type `pgtype.Time`, the golang equivalent type is `*int64`.
...
func (m *iMapperImpl) ToDomain(in Database) Domain {
	...
	if in.A.Valid {
		out.A = &in.A.Microseconds
	}

	var v0 *int64
	if in.B.Valid {
		v0 = &in.B.Microseconds
	}
	if v0 != nil {
		out.B = *v0
	}
